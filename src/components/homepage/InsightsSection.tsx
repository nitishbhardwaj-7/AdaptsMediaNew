...
const InsightsSection = () => {
  return (
    <section className="relative bg-black text-white py-20 px-10 overflow-hidden font-sans flex flex-col items-center justify-center">
      ...
      */}
      <div className="relative z-20 max-w-[1450px] px-20 w-full">
